...
OUT_DIR = ROOT / "main_alternatives_complete_corrected_20260411"
OUT_NOXY_JSON = OUT_DIR / "spatial_block_validation_no_xy_100km_summary.json"
OUT_DIST_CSV = OUT_DIR / "predictor_distribution_audit.csv"
OUT_RESP_CSV = OUT_DIR / "main_other_response_rf_metrics.csv"
OUT_REPORT = OUT_DIR / "main_alternatives_complete_corrected_report.md"
...
def main() -> None:
    ...
    lines = [
        ...
        f"- Reference 100 km block holdout with `x/y`: R2=`{float(spatial_xy_summary['group_holdout_20pct']['r2']):.6f}`",
        "",
