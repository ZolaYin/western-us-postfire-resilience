"""
Simplified GWR script for the raw proxy EVT Resistance pathway.
...
- response: Resistance
- predictor source-of-truth: predictors_gwr_proxy_evt.txt from resistance_modeling_plan

Key difference from proxy-z package:
- FS_EVT_resistance_proxy_z is replaced by raw/original FS_EVT_resistance_proxy

Outputs:
- gwr_raw_proxy_evt_summary.txt
- gwr_raw_proxy_evt_metadata.json
- gwr_raw_proxy_evt_coefficients.parquet
