...
DEFAULT_PREDICTORS = Path("/path/to/google-drive/我的云端硬盘/US_Fire_and_Ecology_Data/WUS_1km/grouped_gwr_execution_package_2026-03-30/predictors_OLS_full_SAF_reference.txt")
