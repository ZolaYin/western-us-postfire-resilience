...
def main() -> None:
    ...
    ).to_csv(out_dir / "rf_near_t0_aggregated_feature_importance.csv", index=False)
    metrics = {
    ...
    (out_dir / "rf_near_t0_aggregated_metrics.json").write_text(json.dumps(metrics, indent=2))
