"""
XGBoost script for the proxy EVT Resistance pathway.
...
Outputs:
- xgb_proxy_evt_feature_importance.csv
- xgb_proxy_evt_metrics.json
...
def main():
    ...
    imp.to_csv(out_dir / "xgb_proxy_evt_feature_importance.csv", index=False)
    ...
    (out_dir / "xgb_proxy_evt_metrics.json").write_text(json.dumps(metrics, indent=2))
