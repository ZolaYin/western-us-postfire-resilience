...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--response", default="Resistance",
                        help="Response column name (default: Resistance)")
...
def main() -> None:
    ...
    required = [response_col, "x", "y", *predictors]
    ...
    print(f"Response: {response_col}  n={len(work)}  predictors={len(predictors)}", flush=True)
    ...
    print(json.dumps({"mgwr_output_dir": str(output_dir)}, ensure_ascii=False))
