...
KERNELS = ["bisquare"]
BW_MIN_CANDIDATES = [20]  # adaptive neighbor minimums
...
out = pd.concat([out, params.add_prefix("b_"), tvals.add_prefix("t_")], axis=1)

out_path = os.path.join(OUT_DIR, "MGWR_Resistance_results_bwmin20_withHuman.parquet")
out.to_parquet(out_path, index=False)

txt_path = os.path.join(OUT_DIR, "MGWR_Resistance_summary_bwmin20_withHuman.txt")
