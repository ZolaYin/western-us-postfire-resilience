...
print("========== MGWR QUICK RUN ==========")
# -----------------------
# Configprint("========== MGWR QUICK RUN ==========")
# -----------------------
...
# ===============================
# QUICK RUN: subsample dataframe
# ===============================
N_QUICK = 1500      # 建议 1000–2000
SEED = 42

if len(df) > N_QUICK:
    df = df.sample(n=N_QUICK, random_state=SEED).copy()

print(f"[QUICK RUN] Using n={len(df)}")
# ===============================
